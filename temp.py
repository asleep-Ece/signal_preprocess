...
def add_arguments(parser):
    ...
    parser.add_argument('--chns', type=list, default=["ppg"], dest="list", help='list of channels', required = True)
...
class PSG_split():
    ...
    def calculate_data_offset(self,psg_dir,offset_dir):
...
d1 = datetime.datetime.strptime('23:59:30', '%H:%M:%S')
d2 = datetime.datetime.strptime('00:01:01', '%H:%M:%S')
delta = d2 - d1
print(delta.seconds)
